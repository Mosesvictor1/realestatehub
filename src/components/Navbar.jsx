    ...
    <div className="absolute top-0 left-0 w-full z-50">
      <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-black ">
        ...
        <ul className="hidden md:flex gap-7 text-white">
          ...
          <a href="#Categories" className="cursor-pointer hover:text-gray-400">
            Categories
          </a>
        ...
        <button className="hidden md:block bg-white hover:bg-green-100 px-8 py-2 rounded-full font-semibold">
          Sign Up
        </button>
        <img
